                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <h6 class="card-title"><%# Eval("Title")%>
                                                    <button dataid='<%# Eval("idBook")%>' runat="server" onserverclick="btnDeleteFav_ServerClick" data-toggle="tooltip" data-placement="left" title="Eliminar libro de favoritos">
